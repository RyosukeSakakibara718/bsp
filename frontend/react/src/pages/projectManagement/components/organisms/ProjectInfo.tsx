...
type ProjectInfoProps = {
  ...
  handleProjectInfoInputChange: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void;
}

const ProjectInfo: React.FC<ProjectInfoProps> = ({projectInfo, handleProjectInfoInputChange}) => {
  return (
