...
describe('SearchBoxコンポーネント', () => {
  it('プレースホルダーが正しく設定されているか確認する', () => {
    render(<SearchBox searchValue="" setSearchValue={() => {}} setShowData={() => {}} placeholder="test" />);
  ...
  it('入力が変更されたときにsetSearchValueが正しく呼び出されるか確認する', () => {
    ...
    render(<SearchBox searchValue="" setSearchValue={setSearchValueMock} setShowData={() => {}} placeholder="test" />);
  ...
  it('Enterキーが押されたときにsetShowDataが正しく呼び出されるか確認する', () => {
    ...
    render(<SearchBox searchValue="" setSearchValue={() => {}} setShowData={setShowDataMock} placeholder="test" />);
