...
import EditTableColumn from "../../../../src/components/atoms/column/EditTableColumn";

describe("EditTableColumnコンポーネント", () => {
  ...
  it("入力が変更されたときにonChangeが正しく呼び出されるか確認する", () => {
    ...
    render(
      <EditTableColumn width="" initialValue="" onChange={onChangeMock} />,
    );
  ...
  it("入力された値がvalueとして保持されていることを確認する", () => {
    render(<EditTableColumn width="" initialValue="" onChange={() => {}} />);
  ...
  it("入力が変更されたときにonChangeが正しく呼び出されるか確認する", () => {
    render(
      <EditTableColumn width="100px" initialValue="" onChange={() => {}} />,
    );
